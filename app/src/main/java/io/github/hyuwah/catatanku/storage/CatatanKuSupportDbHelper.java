...
public class CatatanKuSupportDbHelper extends SQLiteOpenHelper {
    ...
    public CatatanKuSupportDbHelper(Context context){
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        Log.i("CatatanKuSupportDbHelper", "onCreate: Will exec sql :"+SQL_CREATE_NOTES_TABLE );
